...
export function getSupabaseAdmin() {
  if (!_supabaseAdmin) {
    ...
    console.log("[DEBUG] SUPABASE_URL exists:", !!process.env.SUPABASE_URL, "NEXT_PUBLIC_SUPABASE_URL exists:", !!process.env.NEXT_PUBLIC_SUPABASE_URL, "SERVICE_KEY exists:", !!process.env.SUPABASE_SERVICE_KEY);
