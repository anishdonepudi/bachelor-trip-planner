      ...
      <div className="p-3 rounded-md bg-[var(--surface-1)] border border-[var(--border-default)]">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center">
            <button onClick={() => { onEdited?.(); onTimeFiltersChange({ ...timeFilters, maxDuration: timeFilters.maxDuration === null ? 24 : timeFilters.maxDuration <= 1 ? null : timeFilters.maxDuration - 1 }); }}
            ...
            <button onClick={() => { onEdited?.(); onTimeFiltersChange({ ...timeFilters, maxDuration: timeFilters.maxDuration === null ? 1 : timeFilters.maxDuration >= 24 ? null : timeFilters.maxDuration + 1 }); }}
